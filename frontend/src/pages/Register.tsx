...
const registerSchema = z.object({
  ...
  if (data.role === 'university' && (!data.universityCode || !data.universityName)) return false;
  return true;
}, {
...
export const Register: React.FC = () => {
  ...
  const handleRoleChange = (role: 'student' | 'recruiter' | 'university') => {
  ...
  return (
    <div className="flex min-h-[90vh] items-center justify-center px-4 py-16 bg-darkBg text-white">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Prabhat"
                {...register('name')}
                className="w-full rounded-xl border border-white/10 bg-white/5 py-3 pl-11 pr-4 text-sm text-white outline-none transition focus:border-brandPrimary focus:bg-white/10"
              />
            </div>
            {errors.name && (
          ...
          {selectedRole === 'student' && (
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="e.g. DIT123 (Enter to join college cohort)"
                  {...register('universityCode')}
                  className="w-full rounded-xl border border-white/10 bg-white/5 py-3 pl-11 pr-4 text-sm text-white outline-none transition focus:border-brandPrimary focus:bg-white/10"
                />
              </div>
              {errors.universityCode && (
                <p className="mt-1 text-xs text-red-400">{errors.universityCode.message}</p>
              )}
            </div>
          )}
          ...
          {selectedRole === 'university' && (
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. STATEU123"
                  {...register('universityCode')}
                  className="w-full rounded-xl border border-white/10 bg-white/5 py-3 px-4 text-sm text-white outline-none transition focus:border-brandPrimary focus:bg-white/10"
                />
              </div>
            </div>
          )}
