      ...
      <div className="rounded-2xl border border-white/10 bg-cardBg p-6 backdrop-blur">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          {data?.departments?.map((dept: any) => (
            <div key={dept.name} className="bg-white/2 border border-white/5 rounded-xl p-4">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-sm divide-y divide-white/5">
                {students.map((student) => (
                  <tr key={student.id} className="hover:bg-white/1">
                    <td className="py-4">
                    ...
                    <td className="py-4">
                      <button 
                        ...
                        className="flex items-center space-x-1 text-xs font-semibold text-brandPrimary hover:underline"
                      >
