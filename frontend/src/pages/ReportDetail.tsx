    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between rounded-2xl border border-white/10 bg-cardBg p-6 backdrop-blur">
        <div className="flex items-center space-x-4">
          <button 
            ...
            className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 border border-white/10 text-gray-300 transition hover:bg-white/10"
          >
        ...
        <button
          ...
          className="flex items-center justify-center space-x-2 rounded-xl bg-brandPrimary px-5 py-3 text-sm font-semibold text-white shadow shadow-brandPrimary/20 transition hover:bg-brandPrimary/80"
        >
        ...
        <div className="rounded-2xl border border-white/10 bg-cardBg p-6 backdrop-blur">
          ...
          <ul className="space-y-3 text-sm text-gray-300">
            {report.weaknesses?.map((w: string) => (
              <li key={w} className="flex items-start space-x-2">
                <span>•</span>
                <span>{w}</span>
              </li>
            ))}
      ...
      <div className="rounded-2xl border border-white/10 bg-cardBg p-6 backdrop-blur">
        ...
        <div className="space-y-6 divide-y divide-white/5">
          {report.expectedAnswersComparison?.map((qa: any, idx: number) => (
