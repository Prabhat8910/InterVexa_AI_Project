      ...
      <div className="w-full max-w-md rounded-2xl glass-panel p-8 shadow-2xl pulse-glow">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-2">
            {['student', 'recruiter', 'university'].map(role => (<button key={role} type="button" onClick={() => setSelectedRole(role)} className={`rounded-xl border py-2 text-xs font-semibold uppercase tracking-wide transition ${selectedRole === role
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input type="email" placeholder="you@example.com" {...register('email')} className="w-full rounded-xl border border-white/10 bg-white/5 py-3 pl-11 pr-4 text-sm text-white placeholder-gray-500 outline-none transition focus:border-brandPrimary focus:bg-white/10"/>
            </div>
