...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="fixed bottom-0 top-0 left-0 z-30 hidden w-64 border-r border-white/10 bg-darkBg/60 backdrop-blur-md px-6 py-8 md:flex md:flex-col justify-between">
      <div>
